            ...
            {(['host', 'download'] as const).map(m => (
                <button
                    ...
                    style={{
                        ...
                        background: mode === m
                            ? m === 'host' ? '#03e607' : '#ff9100'
                            : 'transparent',
                        boxShadow:  mode === m
                            ? m === 'host' ? '0 0 16px #03e607' : '0 0 16px #ff9100'
                            : 'none',
                    }}
                >
                    {m === 'host' ? '⬆ Send' : '⬇ Receive'}
    ...
    return (
        <div className="flex flex-col gap-1.5">
            ...
            <input
                ...
                onFocus={e => {
                    e.currentTarget.style.border     = '1px solid #03e607';
...
// ── Neon button ───────────────────────────────────────────────────────────────
function NeonButton({
    children, onClick, disabled, color = '#03e607', type = 'button'
}: {
...
function HashBadge({ hash, onCopy }: { hash: string; onCopy: () => void }) {
    ...
    return (
        <div className="rounded-xl p-4 flex flex-col gap-2"
            ...
            <p className="text-xs font-mono tracking-widest uppercase" style={{ color: 'rgba(21, 255, 0, 0.92)' }}>
                Share this hash with receiver
            </p>
            <div className="flex items-center gap-2">
                <code className="flex-1 text-xs font-mono break-all" style={{ color: '#03e607' }}>
                    {hash}
                </code>
                <button onClick={copy}
                    className="shrink-0 px-3 py-1 rounded-lg text-xs font-mono font-bold transition-all"
                    style={{
                        background: copied ? 'rgba(0, 254, 4, 0.44)' : 'rgba(0,255,231,0.08)',
                        color:      '#03e607',
    ...
    return (
        <div className="flex items-start gap-2 rounded-lg px-3 py-2 text-xs font-mono"
            style={{
                ...
                color:  isError ? '#ff9100' : isOk ? '#03e607' : 'rgba(255,255,255,0.5)',
            }}>
...
=======
    ...
    const neonColor  = mode === 'host' ? '#03e607' : '#ff9100';
            ...
            <header className="relative z-10 flex items-center justify-between px-6 py-4"
                ...
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg flex items-center justify-center"
                        ...
                        <span style={{ color: '#03e607', fontSize: 14 }}>✦</span>
                    </div>
                    <div>
                        <span className="font-mono font-black tracking-widest text-lg" style={{ color: '#03e607', textShadow: '0 0 20px #03e607' }}>
                            SHAREX
                        </span>
                ...
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full"
                    ...
                    <div className="w-1.5 h-1.5 rounded-full animate-pulse"
                        style={{ background: myConnectionId ? '#03e607' : '#ff9100' }} />
                    ...
                    <div className="relative z-10 p-6 flex flex-col gap-5"
                            ...
                            <form onSubmit={handleUpload} className="flex flex-col gap-4">
                                ...
                                <div
                                    ...
                                    style={{
                                        ...
                                        border:     `1px dashed ${file ? '#03e607' : 'rgba(255,255,255,0.12)'}`,
                                ...
                                >
                                    ...
                                    <div className="text-sm font-mono text-center" style={{ color: file ? '#03e607' : 'rgba(255,255,255,0.3)' }}>
                                        {file ? file.name : 'Drop file here or click to browse'}
                                    </div>
                                    {file && (
                                        <div className="text-xs font-mono" style={{ color: 'rgba(16, 80, 3, 0.5)' }}>
                                ...
                                <NeonButton type="submit" disabled={isProcessing || !file || !passPhrase} color="#03e607">
                                ...
                                {sendProgress > 0 && (
                                    <div className="flex flex-col gap-2">
                                        <div className="flex justify-between text-xs font-mono"
                                            style={{ color: 'rgba(13, 255, 0, 0.6)' }}>
                                            <span>Sending</span>
                                            <span>{sendProgress}%</span>
                                        </div>
                                        <NeonBar pct={sendProgress} color="#03e607" />
                                    </div>
                                )}
                            </form>
                        )}
                        ...
                        {mode === 'download' && (
                            <form onSubmit={handleDownload} className="flex flex-col gap-4">
                                ...
                                <NeonButton type="submit" disabled={isProcessing || !fileHashInput || !downloadPassword} color="#ff9100">
                                ...
                                {receiveProgress > 0 && (
                                    <div className="flex flex-col gap-2">
                                        <div className="flex justify-between text-xs font-mono"
                                            style={{ color: 'rgba(255, 144, 40, 0.7)' }}>
                                            <span>Receiving</span>
                                            <span>{receiveProgress}%</span>
                                        </div>
                                        <NeonBar pct={receiveProgress} color="#ff9100" />
                                    </div>
                                )}
                ...
                <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        <span className="font-mono font-black text-sm tracking-widest"
                            style={{ color: '#03e607', textShadow: '0 0 10px #2bff0066' }}>
                            SHAREX
                        </span>
                    ...
                    <div className="flex items-center gap-6">
                        {['No servers', 'No logs', 'Open protocol'].map(t => (
                            <span key={t} className="text-xs font-mono flex items-center gap-1.5"
                                ...
                                <span style={{ color: '#03e607' }}>✓</span> {t}
                            </span>
                        ))}
                    </div>
